...
const ITEMS = [
    {title: dates[0], data: [{hour: '12am', duration: '24h', title: 'First Yoga'}]},
    {title: dates[1], data: [{hour: '4pm', duration: '24h', title: 'Pilates ABC'}, {hour: '5pm', duration: '1h', title: 'Vinyasa Yoga'}]},
    {title: dates[2], data: [{hour: '1pm', duration: '24h', title: 'Ashtanga Yoga'}, {hour: '2pm', duration: '1h', title: 'Deep Streches'}, {hour: '3pm', duration: '1h', title: 'Private Yoga'}]},
    {title: dates[3], data: [{hour: '12am', duration: '24h', title: 'Ashtanga Yoga'}]},
    {title: dates[4], data: [{}]},
...
export default class Demo extends Component<{weekView: any}, {}> {
